...
def subset_ui_glyphs(target: Path) -> int:
    """Keep translated UI glyphs and known dynamic carrier names only."""
    text = SOURCES_ZH_CN.read_text(encoding="utf-8") + EXTRA_DYNAMIC_TEXT
...
def main() -> None:
    ...
    (OVERLAY_TTF_DIR / "README.txt").write_text(
        ...
        "Modified: vertical metrics + static UI glyph subset.\n"
        "Scope: translated UI and four known Chinese carrier names; Chinese SSIDs are excluded.\n"
