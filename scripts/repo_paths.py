...
FONT_OVERLAY_SUFFIX = "_zh-cn.ttf"
...
# The binary text patch is deliberately pinned to this exact screen build.
DEPENDS_GL_SCREEN_SDK = "gl-sdk4-screen-large (= git-2026.100.30570-94326f1-1)"
